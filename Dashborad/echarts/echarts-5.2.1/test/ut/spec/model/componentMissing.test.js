...
* under the License.
*/
import { init, use } from '@/src/export/core';
import { PieChart } from '@/src/export/charts';
import { TitleComponent } from '@/src/export/components';
...
;
function makeComponentError(componentName, componentImportName) {
    return `[ECharts] Component ${componentName} is used but not imported.
import { ${componentImportName} } from 'echarts/components';
echarts.use([${componentImportName}]);`;
}
function makeSerieError(seriesName, seriesImportName) {
