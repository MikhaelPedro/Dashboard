...
const componentModelConstructor = ComponentModel;
function extendModel(type, dependencies) {
    ...
    SubModel.type = type;
    SubModel.dependencies = dependencies || [];
    ;
...
describe('componentDependency', function () {
    ...
    it('topologicalTravel_base', function () {
        ...
        componentModelConstructor.topologicalTravel([m1, a1, a2], allList, function (componentType, dependencies) {
    ...
    it('topologicalTravel_a1IsAbsent', function () {
        ...
        const allList = componentModelConstructor.getAllClassMainTypes();
        const result = [];
        componentModelConstructor.topologicalTravel([m1, a2], allList, function (componentType, dependencies) {
            result.push([componentType, dependencies]);
        });
    ...
    it('topologicalTravel_empty', function () {
        ...
        const allList = componentModelConstructor.getAllClassMainTypes();
        const result = [];
        componentModelConstructor.topologicalTravel([], allList, function (componentType, dependencies) {
            result.push([componentType, dependencies]);
        });
    ...
    it('topologicalTravel_isolate', function () {
        ...
        const allList = componentModelConstructor.getAllClassMainTypes();
        const result = [];
        componentModelConstructor.topologicalTravel([a1, a2, m1], allList, function (componentType, dependencies) {
            result.push([componentType, dependencies]);
        });
    ...
    it('topologicalTravel_diamond', function () {
        ...
        const allList = componentModelConstructor.getAllClassMainTypes();
        const result = [];
        componentModelConstructor.topologicalTravel([m1, a1, a2, a3], allList, function (componentType, dependencies) {
            result.push([componentType, dependencies]);
        });
        expect(result).toEqual([[a1, ['dataset']],
            [a3, ['dataset', a1]],
            [a2, ['dataset', a1]],
            [m1, ['dataset', a2, a3]]
        ]);
    ...
    it('topologicalTravel_loop', function () {
        ...
        const allList = componentModelConstructor.getAllClassMainTypes();
        expect(function () {
            componentModelConstructor.topologicalTravel([m1, m2, a1], allList, () => { });
    ...
    it('topologicalTravel_multipleEchartsInstance', function () {
        ...
        componentModelConstructor.topologicalTravel([m2, m1, a1, a2], allList, function (componentType, dependencies) {
            result.push([componentType, dependencies]);
        });
    ...
    it('topologicalTravel_missingSomeNodeButHasDependencies', function () {
        ...
        let result = [];
        let allList = componentModelConstructor.getAllClassMainTypes();
        componentModelConstructor.topologicalTravel([a3, m1], allList, function (componentType, dependencies) {
            result.push([componentType, dependencies]);
        });
        expect(result).toEqual([[a3, ['dataset']], [a2, ['dataset', a3]], [m1, ['dataset', a1, a2]]]);
        result = [];
        allList = componentModelConstructor.getAllClassMainTypes();
        componentModelConstructor.topologicalTravel([m1, a3], allList, function (componentType, dependencies) {
            result.push([componentType, dependencies]);
        });
        expect(result).toEqual([[a3, ['dataset']], [a2, ['dataset', a3]], [m1, ['dataset', a1, a2]]]);
    });
    it('topologicalTravel_subType', function () {
        ...
        const result = [];
        const allList = componentModelConstructor.getAllClassMainTypes();
        componentModelConstructor.topologicalTravel([m1, a1, a2, a4], allList, function (componentType, dependencies) {
            result.push([componentType, dependencies]);
        });
        expect(result).toEqual([[a4, ['dataset']],
            [a2, ['dataset']],
            [a1, ['dataset', a2, a3, a4]],
            [m1, ['dataset', a1, a2]]
        ]);
