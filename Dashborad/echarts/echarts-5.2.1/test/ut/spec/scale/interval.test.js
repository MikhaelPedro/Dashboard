...
describe('scale_interval', function () {
    ...
    describe('extreme', function () {
        it('ticks_min_max', function () {
            ...
            const yAxis = getECModel(chart).getComponent('yAxis', 0);
        ...
        it('ticks_small_value', function () {
            ...
            expect(ticks.map(tick => tick.value)).toEqual([0, 0.0000005, 0.000001, 0.0000015, 0.000002, 0.0000025, 0.000003, 0.0000035]);
