...
describe('createDimensions', function () {
    function doCreateDimensions(source, opt) {
    ...
    it('differentData', function () {
        function doTest(source, opt, result) {
            expect(doCreateDimensions(source, opt)).toEqual(result.map(a => new SeriesDimensionDefine(a)));
        }
        // test dimcount
    ...
    it('differentSysDims', function () {
        ...
        doTest(data, { coordDimensions: ['x', 'y'] }, [
            {
                'otherDims': {},
                'coordDim': 'x',
                'coordDimIndex': 0,
        ...
        doTest(data, { coordDimensions: ['value'] }, [
            {
                'otherDims': {},
                'coordDim': 'value',
                'coordDimIndex': 0,
        ...
        doTest(data, { coordDimensions: [{ name: 'time', type: 'time' }, 'value'] }, [
            {
                'otherDims': {},
                'name': 'time',
                'type': 'time',
    ...
    it('dimsDef', function () {
        ...
        doTest(data, {
            dimensionsDefine: ['挨克思', null, { type: 'ordinal' }],
            coordDimensions: ['x', 'y', 'value']
        ...
        doTest(data, {
            ...
            coordDimensions: [{ name: 'time', type: 'time' }, 'value']
        }, [
            {
                'otherDims': {},
                'displayName': '泰亩',
    ...
    it('encodeDef', function () {
        ...
        doTest(data, {
            dimensionsDefine: ['挨克思', null, '歪溜'],
            coordDimensions: ['x', { name: 'y', type: 'time' }, 'z'],
            encodeDefine: {
                x: 2,
                y: [1, 4],
                tooltip: 2,
