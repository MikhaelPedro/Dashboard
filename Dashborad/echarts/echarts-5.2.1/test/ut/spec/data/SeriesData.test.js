...
import { createSourceFromSeriesDataOption, createSource } from '@/src/data/Source';
import { SOURCE_FORMAT_ARRAY_ROWS, SOURCE_FORMAT_ORIGINAL } from '@/src/util/types';
...
describe('SeriesData', function () {
    describe('Data Manipulation', function () {
        ...
        it('Data with option 1d', function () {
            ...
            expect(data.getItemModel(1).get('somProp')).toEqual('foo');
            expect(data.getItemModel(0).get('somProp')).toBeNull();
        });
        ...
        it('map', function () {
            const data = new SeriesData(['x', 'y'], new Model());
            data.initData([[10, 15], [20, 25], [30, 35]]);
            expect(data.map(['x', 'y'], function (x, y) {
                return [x + 2, y + 2];
    ...
    describe('Data store', function () {
        ...
        it('SeriesData can still get other dims value from store when only part of dims are given.', function () {
            const source = createSource([['A', 15, 20, 'cat'], ['B', 25, 30, 'mouse'], ['C', 35, 40, 'dog']], {
                dimensions: null,
                seriesLayoutBy: null,
                sourceHeader: false
    ...
    describe('id_and_name', function () {
        ...
        describe('id_name_declared_sourceFormat_arrayRows', function () {
            ...
            function testArrayRowsInSource(dimensionsInfo) {
