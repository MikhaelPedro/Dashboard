...
function tmpConvertImageOption(opt) {
    const outOpt = opt;
    outOpt.type = 'rect';
...
describe('graphic_setOption', function () {
    ...
    function propHas(target, propsObj) {
        ...
        if (propsObj instanceof Array) {
            ...
            for (let i = 0; i < propsObj.length; i++) {
                each(target[i], propsObj[i], i);
            }
        }
        else {
            for (const name in propsObj) {
                if (propsObj.hasOwnProperty(name)) {
                    each(target[name], propsObj[name], name);
                }
            }
        }
        function each(targetVal, propVal, keyInfo) {
            ...
            // object or array
                ...
                expect(targetVal.toFixed(NUMBER_PRECISION)).toEqual(propVal.toFixed(NUMBER_PRECISION));
            }
            else {
    ...
    describe('option', function () {
        it('optionFlatten', function () {
            ...
            const graphicOptionList = option.graphic;
            ...
            expect(optionElements[3].style.text === 'aaa' && optionElements[3].parentId === 'gr')
                .toEqual(true);
            expect(optionElements[4].style.text === 'bbb' && optionElements[4].parentId == null)
                .toEqual(true);
        });
        it('groupSetOptionGetOption', function () {
            ...
            function checkExistsAndRelations() {
                ...
                const groupEls = getGraphicElements(els[2], 'graphic');
        ...
        function checkMergeElements(chart, merged) {
            ...
            propHasAll(getGraphicElements(chart, 'graphic'), [
                Object.assign({}, makeIdentityTransformProps()),
                Object.assign(Object.assign({}, makeIdentityTransformProps()), { style: {}, shape: {
                        x: !merged ? 250 : 350,
                        y: 50,
                        width: 20,
                        height: 80
                ...
                Object.assign({}, makeIdentityTransformProps()),
                Object.assign(Object.assign({}, makeIdentityTransformProps()), { style: {
                ...
                Object.assign(Object.assign({}, makeIdentityTransformProps()), { style: !merged
                        ? {}
                        : {
                            fill: 'green'
                        }, shape: {
