...
* under the License.
*/
import { linearMap, parseDate, reformIntervals, getPrecisionSafe, getPrecision, getPercentWithPrecision, quantityExponent, quantity, nice, isNumeric, numericToNumber, addSafe } from '@/src/util/number';
describe('util/number', function () {
    ...
    describe('addSafe', function () {
        it('basic', function () {
            ...
            function test(val0, val1, expected) {
    ...
    describe('getPercentWithPrecision', function () {
        it('basic', function () {
            ...
            for (let i = 0; i < arr.length; i++) {
                result.push(getPercentWithPrecision(arr, i, 0));
            }
            // let sum = 0;
        ...
        it('NaN data', function () {
            ...
            expect(getPercentWithPrecision([1.678, 4.783, 2.664, 0.875, '-'], 2, 0)).toEqual(26);
            expect(getPercentWithPrecision([1.678, 4.783, 2.664, 0.875, '-'], 3, 0)).toEqual(9);
            expect(getPercentWithPrecision([1.678, 4.783, 2.664, 0.875, '-'], 4, 0)).toEqual(0);
            expect(getPercentWithPrecision([0, undefined, '-', null, NaN], 0, 0)).toEqual(0);
            expect(getPercentWithPrecision([0, undefined, '-', null, NaN], 1, 0)).toEqual(0);
            expect(getPercentWithPrecision([0, undefined, '-', null, NaN], 2, 0)).toEqual(0);
            expect(getPercentWithPrecision([0, undefined, '-', null, NaN], 3, 0)).toEqual(0);
            expect(getPercentWithPrecision([0, undefined, '-', null, NaN], 4, 0)).toEqual(0);
        });
    });
