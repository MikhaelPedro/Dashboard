...
class SliderZoomView extends DataZoomView {
    ...
    _resetLocation() {
        ...
        const layoutRect = layout.getLayoutRect(layoutParams, ecSize);
    ...
    _renderDataShadow() {
        ...
        const otherDim = seriesModel.getShadowDim
    ...
    _updateDataInfo(nonRealtime) {
        ...
        function setLabel(handleIndex) {
            ...
            const barTransform = graphic.getTransform(displaybles.handles[handleIndex].parent, this.group);
            const direction = graphic.transformDirection(handleIndex === 0 ? 'right' : 'left', barTransform);
