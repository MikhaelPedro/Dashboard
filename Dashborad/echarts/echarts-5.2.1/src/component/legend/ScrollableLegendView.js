...
class ScrollableLegendView extends LegendView {
    ...
    renderInner(itemAlign, legendModel, ecModel, api, selector, orient, selectorPosition) {
        ...
        const pageIconSizeArr = zrUtil.isArray(pageIconSize)
        ...
        function createPageButton(name, iconIdx) {
            ...
            const icon = graphic.createIcon(legendModel.get('pageIcons', true)[legendModel.getOrient().name][iconIdx], {
    ...
    _layoutContentAndController(legendModel, isFirstRender, maxSize, orientIdx, wh, hw, yx, xy) {
        ...
        const pageButtonGap = zrUtil.retrieve2(legendModel.get('pageButtonGap', true), legendModel.get('itemGap', true));
        ...
        pageInfo.pageIndex != null && graphic.updateProps(contentGroup, { x: pageInfo.contentPosition[0], y: pageInfo.contentPosition[1] }, 
    ...
    _updatePageInfoView(legendModel, pageInfo) {
        ...
        pageText && pageFormatter && pageText.setStyle('text', zrUtil.isString(pageFormatter)
