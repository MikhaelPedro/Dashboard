...
class LegendView extends ComponentView {
    ...
    render(legendModel, ecModel, api) {
        ...
        const layoutRect = layoutUtil.getLayoutRect(zrUtil.defaults({
    ...
    renderInner(itemAlign, legendModel, ecModel, api, selector, orient, selectorPosition) {
        ...
        each(legendModel.getData(), function (legendItemModel, dataIndex) {
            ...
            if (seriesModel) {
                ...
                const itemGroup = this._createItem(seriesModel, name, dataIndex, legendItemModel, legendModel, itemAlign, lineVisualStyle, style, legendIcon, selectMode);
                ...
                ecModel.eachRawSeries(function (seriesModel) {
                    ...
                    if (seriesModel.legendVisualProvider) {
                        ...
                        const itemGroup = this._createItem(seriesModel, name, dataIndex, legendItemModel, legendModel, itemAlign, {}, style, legendIcon, selectMode);
    ...
    _createSelector(selector, legendModel, api, orient, selectorPosition) {
    ...
    _createItem(seriesModel, name, dataIndex, legendItemModel, legendModel, itemAlign, lineVisualStyle, itemVisualStyle, legendIcon, selectMode) {
        ...
        const style = getLegendStyle(legendIcon, legendItemModel, lineVisualStyle, itemVisualStyle, drawType, isSelected);
    ...
    layoutInner(legendModel, itemAlign, maxSize, isFirstRender, selector, selectorPosition) {
        const contentGroup = this.getContentGroup();
        const selectorGroup = this.getSelectorGroup();
...
function getLegendStyle(iconType, legendModel, lineVisualStyle, itemVisualStyle, drawType, isSelected) {
    ...
    // itemStyle
    const legendItemModel = legendModel.getModel('itemStyle');
    ...
    // lineStyle
    const legendLineModel = legendModel.getModel('lineStyle');
