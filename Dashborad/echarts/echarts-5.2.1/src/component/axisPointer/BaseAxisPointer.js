...
class BaseAxisPointer {
    ...
    createPointerEl(group, elOption, axisModel, axisPointerModel) {
        ...
        if (pointerOption) {
            const pointerEl = inner(group).pointerEl = new graphic[pointerOption.type](clone(elOption.pointer));
            group.add(pointerEl);
        }
    }
    /**
    ...
    createLabelEl(group, elOption, axisModel, axisPointerModel) {
        if (elOption.label) {
            const labelEl = inner(group).labelEl = new graphic.Text(clone(elOption.label));
            group.add(labelEl);
     ...
     * @protected
     */
    updatePointerEl(group, elOption, updateProps) {
     ...
     * @protected
     */
    updateLabelEl(group, elOption, updateProps, axisPointerModel) {
