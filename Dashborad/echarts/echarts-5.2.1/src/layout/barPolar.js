...
function barLayoutPolar(seriesType, ecModel, api) {
    ...
    const barWidthAndOffset = calRadialBar(zrUtil.filter(ecModel.getSeriesByType(seriesType), function (seriesModel) {
...
function calRadialBar(barSeries) {
    ...
    zrUtil.each(barSeries, function (seriesModel, idx) {
        ...
        let barWidth = parsePercent(seriesModel.get('barWidth'), bandWidth);
        const barMaxWidth = parsePercent(seriesModel.get('barMaxWidth'), bandWidth);
