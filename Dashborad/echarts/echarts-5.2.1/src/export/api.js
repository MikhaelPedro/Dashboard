...
import * as zrender_1 from 'zrender/src/zrender';
export { zrender_1 as zrender };
import * as matrix_1 from 'zrender/src/core/matrix';
export { matrix_1 as matrix };
import * as vector_1 from 'zrender/src/core/vector';
export { vector_1 as vector };
import * as zrUtil_1 from 'zrender/src/core/util';
export { zrUtil_1 as zrUtil };
import * as color_1 from 'zrender/src/tool/color';
