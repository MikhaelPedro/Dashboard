...
class Radar {
    ...
    update(ecModel, api) {
        ...
        each(indicatorAxes, function (indicatorAxis, idx) {
            ...
            const scale = indicatorAxis.scale;
            const fixedMin = parseAxisModelMinMax(scale, axisModel.get('min', true));
            const fixedMax = parseAxisModelMinMax(scale, axisModel.get('max', true));
